# app/feed/routes/route_edit_comment_nested.py
...
@bp.route("/<int:post_id>/comments/<int:comment_id>", methods=["PATCH", "POST"])
@login_required
def edit_comment_nested(post_id: int, comment_id: int):
